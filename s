...
--[[ 
                                         ...
                                         --{[░▒▓█ THE LAST STAR GLITCHER █▓▒░}]--

                                                        Made with love by Asarii_IV
                                         Edits by Ronald McDonald SS dev#2194
                                   Convert by studio dummy :heart:
                           FE Animation Compatibility by me
                    FDless inside the FE Animation Compatibility by MyWorld
                Uses permanent death not like rami's fe "fake permanent death"
...
local removeleftlegmesh = false,
local removetorsomesh = false
	}
print[[
                                     // A P E X \\
                                    --{[░▒▓█ THE LAST STAR GLITCHER █▓▒░}]--
...
game.Players:Chat("-gh 11159410305, 11263254795, 12344545199, 12344591101, 13012415545, 8998968191, 9730887811, 9730942837, 9730945610, 9730902206, 9666081057, 9666089815")
game:GetService("Players").LocalPlayer.Character["ParadoxBladesL"].Name = 'ParadoxOrangeBladesL'
game:GetService("Players").LocalPlayer.Character["ParadoxBladesR"].Name = 'ParadoxOrangeBladesR'
wait(1)
game:GetService("Players").LocalPlayer.Character["ParadoxBladesL"].Name = 'ParadoxPurpleBladesL'
game:GetService("Players").LocalPlayer.Character["ParadoxBladesR"].Name = 'ParadoxPurpleBladesR'
wait(1)
if removewingmesh then
game:GetService("Players").LocalPlayer.Character["ParadoxOrangeBladesL"].Handle.SpecialMesh:Destroy()
game:GetService("Players").LocalPlayer.Character["ParadoxOrangeBladesR"].Handle.SpecialMesh:Destroy()
end
wait(1)
game:GetService("Players").LocalPlayer.Character["ParadoxOrangeBladesL"].Name = '1'
game:GetService("Players").LocalPlayer.Character["ParadoxOrangeBladesR"].Name = '2'
wait(1)
if removewingmesh then
game:GetService("Players").LocalPlayer.Character["ParadoxPurpleBladesL"].Handle.SpecialMesh:Destroy()
game:GetService("Players").LocalPlayer.Character["ParadoxPurpleBladesR"].Handle.SpecialMesh:Destroy()
end
wait(1)
game:GetService("Players").LocalPlayer.Character["ParadoxPurpleBladesL"].Name = '3'
game:GetService("Players").LocalPlayer.Character["ParadoxPurpleBladesR"].Name = '4'
wait(1)
if removewingmesh then
game:GetService("Players").LocalPlayer.Character["ParadoxBladesR"].Handle.SpecialMesh:Destroy()
game:GetService("Players").LocalPlayer.Character["ParadoxBladesL"].Handle.SpecialMesh:Destroy()
end
wait(1)
game:GetService("Players").LocalPlayer.Character["ParadoxBladesL"].Name = '5'
game:GetService("Players").LocalPlayer.Character["ParadoxBladesR"].Name = '6'
game:GetService("Players").LocalPlayer.Character["Ring of Protection RedAccessory"].Name = '7'
wait(1)
if removerighthandmesh then
game:GetService("Players").LocalPlayer.Character["Extra Right hand (Blocky)_white"].Handle.SpecialMesh:Destroy()
end
if removelefthandmesh then
game:GetService("Players").LocalPlayer.Character["Extra Left hand (Blocky)_white"].Handle.SpecialMesh:Destroy()
end
if removetorsomesh then
game:GetService("Players").LocalPlayer.Character["GreyArgyleCropVest"].Handle.SpecialMesh:Destroy()
end
wait(1)
if removerightlegmesh then
game:GetService("Players").LocalPlayer.Character["Unloaded head"].Handle.SpecialMesh:Destroy()
end
wait(1)
if removeleftlegmesh then
game:GetService("Players").LocalPlayer.Character["MeshPartAccessory"].Handle.SpecialMesh:Destroy()
end
wait(1)
...
local script = game:GetObjects("rbxassetid://12886728610")[1]
...
game:GetService("Players").LocalPlayer.Character["1"].Handle.att1_Handle.Parent = wing1.Core
wing1.Core.att1_Handle.Position = Vector3.new(-0,-3.7,0)

game:GetService("Players").LocalPlayer.Character["2"].Handle.att1_Handle.Parent = wing2.Core
wing2.Core.att1_Handle.Position = Vector3.new(-0,-3.7,0)

game:GetService("Players").LocalPlayer.Character["3"].Handle.att1_Handle.Parent = wing3.Core
wing3.Core.att1_Handle.Position = Vector3.new(-0,-3.7,0)

game:GetService("Players").LocalPlayer.Character["4"].Handle.att1_Handle.Parent = wing4.Core
wing4.Core.att1_Handle.Position = Vector3.new(-0,-3.7,0)

game:GetService("Players").LocalPlayer.Character["5"].Handle.att1_Handle.Parent = wing5.Core
wing5.Core.att1_Handle.Position = Vector3.new(-0,-3.7,0)

game:GetService("Players").LocalPlayer.Character["6"].Handle.att1_Handle.Parent = wing6.Core
wing6.Core.att1_Handle.Position = Vector3.new(-0,-3.7,0)

game:GetService("Players").LocalPlayer.Character["7"].Handle.att1_Handle.Parent = plr.Core.Base.Penta
...
NG.LowerHalf.ScriptName.Text = "Fatal Apex Form // "..nametodisplay
...
Theme.SoundId = "rbxassetid://7023887630"
...
if game.PlaceId ~= 2578460148 then
	...
	voice.SoundId = "rbxassetid://184105182"
	voice.Volume = 1
	voice.Parent = Root
...
if chat then getrealfemboy("Surrender!") end
print("Surrender!")
local RPA,RPS,NO = ray(Root.Position,V3(0,-1000,0))
if RPA then
...
function formswitch(textcolor,textstrokecolor,theme,primary,secondary,walkspeed,jumppower,attack,formname,formfont,wingstyle,formidle,themevolume,fancyexplosionbool,altindexnumber,corebool,scriptname,dynamic,themename,extrawingsbool,marbleimage)
	...
	if fury == true then
		...
		Theme.SoundId = getcustomasset("Acrophobia.mp3")
		Theme.Volume = 1.5
		Theme.TimePosition = 36
		themename = "Ultra Skidded Last Star // Devilization"
	end
...
function apexslam()
	...
	if target then
		if target.Humanoid.Health > target.Humanoid.MaxHealth*.3 and fury == false and instakill == false then
			target = nil
			if chat then getrealfemboy("Not weak enough.") end
			print("Not weak enough.")
		end
	end
	if target == nil then
		canswitch = true
		...
		if script.Values.CurrentForm.Value == "OBSCURITY" then
			...
			if chat then getrealfemboy("P i t a f u l") end
			print("P i t a f u l")
		else
			if chat then getrealfemboy("!!SHUT UP and DIE!! -Ronald McDonald told me :)") end
			print("!!SHUT UP and DIE!! -Ronald McDonald told me :)")
		end
...
function YOU()
	...
	if root then
		if root.Parent:FindFirstChild("LastStar") then
			if root.Parent.LastStar.Values.Safezone.Value == 1 then
				...
				Root.Anchored=false
				cancelchain = true
				if chat then getrealfemboy("I'm not a coward.") end
				print("I'm not a coward.")
			end
		end
	end
	...
	if not target or not hum or not root or not torso then
		if script.Values.Safezone.Value == 0 and cancelchain == false then
			if chat then getrealfemboy("I need a target.") end
...
function erase()
	...
	if script.Values.CurrentForm.Value ~= "EUPHORIA" then
		...
		if chat then getrealfemboy("TIME TO FINISH THIS!") end
		print("TIME TO FINISH THIS!")
	else
		sound(Root.CFrame,6460148774,1,1,0,200)
		if chat then getrealfemboy("uwu") end
	    print("uwu")
	end
	Root.Anchored=true
	canswitch = false
...
local apexlines = {"Waste of Space.","Get out of my way.",game.Players.LocalPlayer.Name.." re-made me."}
...
local anarchylines = {"Ready for erasure?","Can you feel the chaos?","I hate people like you...."}
...
local warpspeedlines = {"Untouchable!.","I saw "..game.Players.LocalPlayer.Name.." around here somewhere.","Demolition!"}
...
local baseformtable = {
	["APEX"]=function() if altwheel == false then formswitch(C3R(0,0,0),C3R(255,0,0),6992770710,C3R(255,0,0),C3R(0,0,0),16,50,1,"APEX","Antique","APEX","APEX",.4,true,0,true,"THE REAL DEAL",false,"C a l m | D o w n",false,"rbxassetid://1841647093") if chat then getrealfemboy(apexlines[math.random(1,#apexlines)]) end print(apexlines[math.random(1,#apexlines)]) returnwheel = "BASE" end end;
	["REPRESSION"]=function() if altwheel == false then formswitch(C3R(0,0,0),C3R(255,130,0),1847588523,C3R(255,100,0),C3R(0,0,0),20,40,1,"REPRESSION","Oswald","REPRESSION","REPRESSION",.4,true,0,true,"THE REAL DEAL",false,"Calm Down Buddy",false,"rbxassetid://6593357327") if chat then getrealfemboy(repressionlines[math.random(1,#repressionlines)]) end print(repressionlines[math.random(1,#repressionlines)]) end end;
	["EXECUTION"]=function() if altwheel == false then formswitch(C3R(255,255,255),C3R(0,170,255),1839931160,script.Dynamics.Execution.Value,C3R(200,200,200),100,100,1,"EXECUTION","Bodoni","EXECUTION","EXECUTION",.4,true,0,true,"THE REAL DEAL",true,"8 Bit Dubstep",false,"rbxassetid://6593369926") if chat then getrealfemboy(executionlines[math.random(1,#executionlines)]) end print(executionlines[math.random(1,#executionlines)]) end end;
	["ANARCHY"]=function() if altwheel == false then formswitch(C3R(0,0,0),C3R(100,0,255),9245552700,C3R(80,0,255),C3R(0,0,0),60,100,1,"ANARCHY","Antique","ANARCHY","ANARCHY",.6,true,0,true,"THE REAL DEAL",false,"TacoBot 3,000",false,"rbxassetid://6595974803") if chat then getrealfemboy(anarchylines[rand(1,3)]) end print(anarchylines[rand(1,3)]) end end;
	["VIRTUE"]=function() if altwheel == false then formswitch(C3R(0,230,255),C3R(255,255,255),9046862941,C3R(80,190,255),C3R(180,180,180),55,50,1,"VIRTUE","FredokaOne","VIRTUE","VIRTUE",.4,true,0,true,"THE REAL DEAL",false,"Sunset Chill (Bed Version)",false,"rbxassetid://6595997907") if chat then getrealfemboy(virtuelines[math.random(1,#virtuelines)]) end print(virtuelines[math.random(1,#virtuelines)]) end end;
	["ABSOLUTION"]=function() if altwheel == false then formswitch(C3R(255,80,80),C3R(255,0,00),9045344148,C3R(255,0,0),C3R(255,80,80),300,100,1,"ABSOLUTION","Fondamento","ABSOLUTION","ABSOLUTION",.4,true,0,true,"THE REAL DEAL",false,"Forgotten Dreams",false,"rbxassetid://6595974875") if chat then getrealfemboy(absolutionlines[math.random(1,#absolutionlines)]) end print(absolutionlines[math.random(1,#absolutionlines)]) end  end;
	["INFERNUM"]=function() if altwheel == false then formswitch(C3R(0,0,0),C3R(255,70,0),1839526985,C3R(255,70,0),C3R(0,0,0),14,50,1,"INFERNUM","JosefinSans","INFERNUM","INFERNUM",.4,true,0,true,"THE REAL DEAL",false,"Dubstep Hero",false,"rbxassetid://6595974633") if chat then getrealfemboy(infernumlines[math.random(1,#infernumlines)]) end print(infernumlines[math.random(1,#infernumlines)]) end end;
	["DISSONANCE"]=function() if altwheel == false then formswitch(C3R(0,21,128),C3R(107,0,128),1847523310,C3R(107,0,128),C3R(0,21,128),50,50,1,"DISSONANCE","Kalam","DISSONANCE","DISSONANCE",.35,true,0,true,"THE REAL DEAL",true,"Robot Electronic's",false,"rbxassetid://6595974744") if chat then getrealfemboy(dissonancelines[math.random(1,#dissonancelines)]) end print(dissonancelines[math.random(1,#dissonancelines)]) end end;
	["WARPSPEED"]=function() if altwheel == false then formswitch(C3R(70, 181, 255),C3R(208, 241, 255),1839527296,C3R(151, 165, 255),C3R(64, 121, 255),400,50,1,"WARPSPEED","Michroma","WARPSPEED","WARPSPEED",.4,true,0,true,"THE REAL DEAL",false,"100% S P E E D",false,"rbxassetid://6596658428") if chat then getrealfemboy(warpspeedlines[math.random(1,#warpspeedlines)]) end print(warpspeedlines[math.random(1,#warpspeedlines)]) end end;
	["INTRICACY"]=function() if altwheel == false then formswitch(C3R(0,255,0),C3R(255,255,255),1847754836,C3R(0,255,0),C3R(255,255,255),200,150,1,"INTRICACY","RobotoCondensed","INTRICACY","INTRICACY",.55,true,0,true,"THE REAL DEAL",false,"Deleted Files",false,"rbxassetid://6595974565") if chat then getrealfemboy(intricacylines[math.random(1,#intriacylines)]) end print(intricacylines[math.random(1,#intriacylines)]) end end;
}
local disgraceformtable = {
	["DOWNFALL"]=function() if altwheel == false then formswitch(C3R(0,0,0),C3R(190,60,60),6941090644,C3R(190, 60, 60),C3R(0,0,0),16,50,1,"DOWNFALL","Antique","APEX","DOWNFALL",.6,true,0,true,"THE REAL DEAL?",false,"Water Spirit // P.L.U.R",false,"rbxassetid://6595974565") returnwheel = "DISGRACE" end end;
	["ADMISSION"]=function() formswitch(C3R(0,0,0),C3R(255, 175, 62),1057854857,C3R(170, 130, 60),C3R(0,0,0),20,40,1,"ADMISSION","Oswald","REPRESSION","ADMISSION",.4,true,0,true,"THE REAL DEAL?",false,"Bossfight // Mescalink") returnwheel = "DISGRACE" end;  -- REPRESSION
	["STIGMA"]=function() formswitch(C3R(0,0,0),script.Dynamics.Execution.Value,5113228942,script.Dynamics.Execution.Value,C3R(0,0,0),100,100,1,"STIGMA","Bodoni","EXECUTION","STIGMA",.4,true,0,true,"THE REAL DEAL?",true,"Yooh // Heracles (Extended)") returnwheel = "DISGRACE" end; -- EXECUTION
	["SILENCE"]=function() formswitch(C3R(0,0,0),C3R(70, 0, 255),5097730967,C3R(70, 0, 255),C3R(0, 0, 0),60,100,1,"SILENCE","Antique","ANARCHY","SILENCE",.3,true,0,true,"THE REAL DEAL?",false,"This Song is 3:04 Min's LONG LOL") returnwheel = "DISGRACE" end; -- ANARCHY
	["IGNOMINY"]=function() end; -- VIRTUE
	["RETENTION"]=function() formswitch(C3R(0,0,0),C3R(255, 80, 140),6735674317,C3R(255, 80, 140),C3R(255, 0, 70),300,100,1,"RETENTION","Fondamento","ABSOLUTION","RETENTION",1.1,true,0,true,"THE REAL DEAL?",false,"Yonaka // Vespertilism") returnwheel = "DISGRACE" end; -- ABSOLUTION
...
local apexalttable = {
	["APEX"]=function()
		...
		if x > 1 then
			formswitch(C3R(0,0,0),C3R(255,0,0),6454152476,C3R(255,0,0),C3R(0,0,0),16,50,1,"APEX","Antique","APEX","APEX",.4,false,0,false,"THE REAL DEAL",false,"C a l m | D o w n")
		else
			...
			getrealfemboy("Oh boy here we go again, huh Ronald.")
		end
	end;
	...
	["AGONY"]=function()  formswitch(C3R(0,0,0),C3R(200,0,0),8703175543,C3R(200,0,0),C3R(0,0,0),14,45,1.1,"AGONY","Antique","APEX","APEX",.25,false,2,false,"LΔPSΣ",false,"-| D o o M |-") end;
	...
	["CALAMITY"]=function() formswitch(C3R(20, 51, 66),C3R(50, 130, 167),9038274374,C3R(50, 130, 167),C3R(20, 51, 66),30,40,.8,"CALAMITY","Fondamento","APEX","APEX",.4,false,6,false,"THE REAL DEAL",false,"Dead man's life story") end;
	["REVOLTION"]=function() formswitch(C3R(230,167,167),C3R(167,69,69),1836057239,C3R(167, 69, 69),C3R(230,167,167),13,70,1.3,"REVOLTION","Garamond","APEX","APEX",.4,false,-1,false,"THE REAL DEAL",false,"Ultra Killer // more like Ultra Loser") end;
	["PROSPECTUM"]=function() formswitch(C3R(255,164,119),C3R(143,226,255),1839542961,C3R(255,164,119),C3R(143,226,255),16,60,.95,"PROSPECTUM","Oswald","APEX","APEX",.4,false,-1,false,"THE REAL DEAL",false,"Don't get dizzy now :)") end;
...
local repressionalttable = {
	["REPRESSION"]=function() formswitch(C3R(0,0,0),C3R(255,130,0),1843404009,C3R(255,100,0),C3R(0,0,0),20,40,1,"REPRESSION","Oswald","REPRESSION","REPRESSION",.4,false,0,false,"THE REAL DEAL",false,"Calm Down buddy") end;
	["ANNIHILATION"]=function() formswitch(C3R(0,0,0),C3R(255,55,70),9048375035,C3R(255,55,70),C3R(0,0,0),22,50,.95,"ANNIHILATION","Antique","REPRESSION","REPRESSION",.3,false,1,false,"GREAT TURMOIL",false,"Die Potato") end;
	...
	["Press Play BRO"]=function() formswitch(C3R(0,0,0),C3R(168,43,45),5410085763,C3R(168,43,45),C3R(0,0,0),10,50,1.4,"FOCUS","Code","REPRESSION","REPRESSION",.5,false,4,false,"THE REAL DEAL",false,"This Song is 3:04 Min's LONG LOL") end;
	["DEVIANCE"]=function() formswitch(C3R(0,0,0),C3R(100,0,0),7023887630,C3R(70,0,0),C3R(0,0,0),16,50,1.1,"DEVIANCE","Antique","REPRESSION","REPRESSION",.4,false,-1,false,"THE REAL DEAL",false,"B L O O M") end;
	["ROXANNE"]=function() formswitch(C3R(124, 0, 51),C3R(255,0,0),6808308228,C3R(255,0,0),C3R(124, 0, 51),16,50,1,"RESONANCE","Antique","REPRESSION","REPRESSION",.3,false,-1,false,"THE REAL DEAL",false,"Hyper Potions & Nokae - Expedition: Yeah it's Monstercat :/") end;
...
local executionalttable = {
	["EXECUTION"] = function() formswitch(C3R(255,255,255),C3R(0,170,255),4514914581,script.Dynamics.Execution.Value,C3R(200,200,200),100,100,1,"EXECUTION","Bodoni","EXECUTION","EXECUTION",.4,false,0,false,"THE REAL DEAL",true,"8 Bit Dubstep") end;
	["SPECTRAFIELD"] = function() local x = rand(1,10000) if x ~= 1 then formswitch(script.Dynamics.Spectrafield.Value,C3R(255,255,255),5348965486,script.Dynamics.Spectrafield.Value,C3R(255,255,255),200,50,.85,"SPECTRAFIELD","Arcade","EXECUTION","EXECUTION",.35,false,1,false,"THE REAL DEAL",true,"Dude...Just play it cool......") else formswitch(C3R(0,60,255),C3R(255,255,255),6245897503,C3R(0,0,255),C3R(255,255,255),200,50,1,"PEPSIMAN","ArialBold","EXECUTION","EXECUTION",.2,false,666,false,"HELL ITSELF",true,"Turbo // Pepsiman Pepsiman Pepsiman") getrealfemboy(OHGODWHYHELPMESOMEBODYPLEASE[rand(1,#OHGODWHYHELPMESOMEBODYPLEASE)]) end end;
	...
	["ΣTERNITY"] = function() formswitch(C3R(200,200,200),C3R(255,255,255),7026389855,C3R(255,255,255),C3R(150,150,150),200,50,.9,"ΣTERNITY","SourceSansSemibold","EXECUTION","EXECUTION",.3,false,-1,false,"THE REAL DEAL",false,"Egipt Rad B)") end;
	...
	["UTTERANCE"] = function() formswitch(C3R(240,0,40),C3R(10,10,10),7023771708,c3(240,0,40),C3R(10,10,10),300,90,.8,"UTTERANCE","Fondamento","EXECUTION","EXECUTION",.4,false,30,false,"THE REAL DEAL",true,"Please...Just stay still :|") end;
...
local anarchyalttable = {
	["ANARCHY"]=function() formswitch(C3R(0,0,0),C3R(100,0,255),5671763707,C3R(80,0,255),C3R(0,0,0),60,100,1,"ANARCHY","Antique","ANARCHY","ANARCHY",.6,false,0,false,"THE REAL DEAL",false,"meganeko // The Cyber Grind") end;
	...
	["HYPERTRANCE"]=function() formswitch(C3R(249, 196, 255),C3R(127, 92, 241),6770715109,C3R(127, 92, 241),C3R(249, 196, 255),60,100,1,"HYPERTRANCE","GothamBold","ANARCHY","ANARCHY",.6,false,2,false,"THE REAL DEAL",false,"meganeko // Robot Language") end;
	["LUNAR"]=function() formswitch(C3R(0,0,0),C3R(0,0,255),4747259294,C3R(0,0,255),C3R(0,0,0),80,60,1.1,"LUNAR","Bodoni","ANARCHY","ANARCHY",.3,false,3,false,"LΔPSΣ",false,"Lchavasse // Space Abyss") end;
	...
	["EXTERMINATION"]=function() formswitch(C3R(0,0,0),C3R(160,0,0),4239221655,C3R(130,0,0),C3R(0,0,0),200,70,1,"EXTERMINATION","Fondamento","ANARCHY","ANARCHY",.4,false,0,false,"THE REAL DEAL",false,"kenta-v.ez. // ListENiNg to spEEDcorE turNs you iNto An idiot (Kobaryo's FTN-Remix)") end;
...
local virtuealttable = {
	["VIRTUE"]=function() formswitch(C3R(0,230,255),C3R(255,255,255),6289868990,C3R(80,190,255),C3R(180,180,180),55,50,1,"VIRTUE","FredokaOne","VIRTUE","VIRTUE",.4,false,0,false,"THE REAL DEAL",false,"Sunset Chill (Bed Version)") end;
	["DIAPHANOUS"]=function() formswitch(C3R(150,150,150),C3R(255,255,255),586732256,C3R(200,200,200),C3R(120,120,120),60,40,1.25,"DIAPHANOUS","Fantasy","VIRTUE","VIRTUE",.4,false,1,false,"LΔPSΣ",false,"xi // Happy End of the World") end;
	...
	["CONTRIVANCE"]=function() formswitch(C3R(255,255,255),C3R(255, 0, 115),6382627214,C3R(255,0,115),C3R(220,220,220),23,50,1.75,"CONTRIVANCE","Cartoon","VIRTUE","VIRTUE",.4,false,3,false,"THE REAL DEAL",false,"Magic Sword // Uprising") end;
	["ENIGMA"]=function() formswitch(C3R(0,0,0),C3R(0,130,255),1747455288,C3R(0,110,255),C3R(0,0,0),70,50,.8,"ENIGMA","SciFi","VIRTUE","VIRTUE",.4,false,3,false,"LΔPSΣ",false,"XI // Ascension to Heaven") end;
	...
	["HEARTFELT"]=function() formswitch(C3R(35,14,57),C3R(127,96,170),5712004125,C3R(35,14,57),C3R(127,96,170),51,50,1,"HEARTFELT","Nunito","VIRTUE","VIRTUE",.4,false,3,false,"CHROMOSPHERIC",false,"Cororo // ウエンレラの氷華") end;
...
local dissonancealttable = {
	["DISSONANCE"]=function() formswitch(C3R(0,21,128),C3R(107,0,128),4857461826,C3R(107,0,128),C3R(0,21,128),50,50,1,"DISSONANCE","Kalam","DISSONANCE","DISSONANCE",.35,false,0,false,"THE REAL DEAL",true,"Robot Electronic's") end;
	["DISTORTION"]=function() formswitch(C3R(255,0,0),C3R(0,0,0),3108672499,C3R(255,0,0),C3R(0,0,0),60,40,1.1,"DISTORTION","SciFi","DISSONANCE","DISSONANCE",.35,false,1,false,"LΔPSΣ",true,"Kobaryo // Necrophagiatoast") end;
	["ALTERATION"]=function() formswitch(C3R(255,255,255),C3R(0,0,0),833792144,C3R(255,255,255),C3R(0,0,0),130,30,.8,"ALTERATION","Bodoni","DISSONANCE","DISSONANCE",.4,false,2,false,"LΔPSΣ",true,"The Quick Brown Fox - PROSELYTISM") end
}
local nihilalttable = {
	["NIHIL"]=function() formswitch(C3R(0,0,0),C3R(0,0,0),5249099148,C3R(0,0,255),C3R(255,255,255),100,50,1,"NIHIL","SciFi","NIHIL","NIHIL",.2,false,0,false,"THE REAL DEAL",true,"Water Spirit // Aries") end;
	["ANOMALY"]=function() formswitch(C3R(0,0,0),C3R(0,0,0),1228696343,C3R(255,0,0),C3R(255,255,255),200,40,.9,"ANOMALY","Arcade","NIHIL","NIHIL",.25,false,1,false,"THE REAL DEAL",true,"Camellia // Anomaly") end;
	...
	["404"]=function() formswitch(C3R(24, 40, 130),C3R(47, 78, 255),6111767199,C3R(47, 78, 255),C3R(24, 40, 130),400,50,.5,"404","Code","NIHIL","NIHIL",.35,false,-1,false,"THE REAL DEAL",true,"RoughSketch // Ill") end;
	["ABERRATION"]=function() formswitch(C3R(225, 225, 255),C3R(252, 226, 5),1639681622,C3R(252, 226, 5),C3R(225, 225, 255),300,60,.5,"ABERRATION","Cartoon","NIHIL","NIHIL",.35,false,-1,false,"THE REAL DEAL",true,"Bossfight // Work") end;
}

local holding1,holding2,holding3 = false,false,false
function keycheck()
	if holding1 == true and holding2 == true and holding3 == true then
		formswitch(C3R(0,0,0),C3R(0,0,0),5249099148,C3R(0,0,255),C3R(255,255,255),100,50,1,"NIHIL","SciFi","NIHIL","NIHIL",.2,true,0,true,"THE REAL DEAL",true,"Water Spirit // Aries")
...
script.Events.Switching.OnServerEvent:Connect(function(player,form)
	...
	if altwheel == false then
		if form == "PERDURANCE" then
			formswitch(c3(255,80,60),c3(65, 90, 255),6471251501,c3(255,80,60),c3(65, 90, 255),400,80,1,"PERDURANCE","Michroma","PERDURANCE","PERDURANCE",3,true,0,true,"THE REAL DEAL",true,"Fear, and Loathing in Las Vegas // Shape of Trust (marbun 1987 Instrumental Cover)",false,"rbxassetid://6595974497")
			if canswitch == true then getrealfemboy(perdurancelines[rand(1,3)]) end
		elseif form == "VINDICTIVE" then
			...
			if x ~= 1 then
				...
				formswitch(C3R(255,255,255),C3R(0,0,255),4159375283,C3R(0,0,255),C3R(170,170,170),500,100,1,"ERROR 404","Fondamento","VINDICTIVE","VINDICTIVE",.3,true,0,true,"THE REAL DEAL",false,"Gram // Sigmund")
			end
			getrealfemboy(vindictivelines[rand(1,3)])
	...
	if altwheel == true and altswitchcooldown == 0 then
		if form == "PERDURANCE" then
			formswitch(c3(255,80,60),c3(65, 90, 255),6471251501,c3(255,80,60),c3(65, 90, 255),400,80,1,"PERDURANCE","Michroma","PERDURANCE","PERDURANCE",3,false,0,false,"THE REAL DEAL",true,"Fear, and Loathing in Las Vegas // Shape of Trust (marbun 1987 Instrumental Cover)")
		...
		elseif form == "PROPOSITUM" then
			formswitch(c3(0,0,60),c3(0,0,255),5182678213,c3(0,0,255),c3(0,0,60),400,80,1,"PROPOSITUM","Merriweather","PERDURANCE","PERDURANCE",1.1,false,0,false,"THE REAL DEAL",false,"Noah // The End")
		elseif form == "OBSESSION" then
			formswitch(c3(50,80,50),c3(60,255,60),5188455408,c3(60,255,60),c3(50,80,50),400,80,1,"OBSESSION","PermanentMarker","PERDURANCE","PERDURANCE",.7,false,0,false,"THE REAL DEAL",false,"MARETU // Magical Doctor")
	...
	if form == "ABSOLUTION" and altwheel == true and altswitchcooldown == 0 then
		formswitch(C3R(255,80,80),C3R(255,0,00),5944346438,C3R(255,0,0),C3R(255,80,80),300,100,1,"ABSOLUTION","Fondamento","ABSOLUTION","ABSOLUTION",.4,false,0,false,"THE REAL DEAL",false,"Forgotten Dreams")
	elseif form == "VICISSITUDE" then
		formswitch(C3R(61, 16, 20),C3R(175, 47, 56),2617725119,C3R(175, 47, 56),C3R(61, 16, 20),600,75,1,"VICISSITUDE","Garamond","ABSOLUTION","ABSOLUTION",.4,false,1,false,"THE REAL DEAL",false,"DJ Grimoire // Noisy Minority")
	...
	elseif form == "ACQUITTAL" then
		formswitch(C3R(100,35,35),C3R(155,30,30),6992712759,C3R(155,30,30),C3R(100,35,35),500,150,1,"ACQUITTAL","Nunito","ABSOLUTION","ABSOLUTION",3,false,10,false,"THE REAL DEAL",false,"	RedOgre, OZIGIRI, DJ Myosuke - Positron Emission")
	end
	...
	if form == "INFERNUM" and altwheel == true and altswitchcooldown == 0 then
		formswitch(C3R(0,0,0),C3R(255,70,0),3619670346,C3R(255,70,0),C3R(0,0,0),14,50,1,"INFERNUM","JosefinSans","INFERNUM","INFERNUM",.45,false,0,false,"THE REAL DEAL",false,"Dubstep Hero")
	elseif form == "HELLFIRE" then
		local x = rand(1,5)
		if x ~= 1 then
			formswitch(C3R(0,0,0),C3R(70,200,255),4620556828,C3R(50,150,255),C3R(0,0,0),20,50,.95,"HELLFIRE","Arcade","INFERNUM","INFERNUM",.4,false,1,false,"THE REAL DEAL",false,"JAKAZiD - Make Me Burn")
		else
	...
	elseif form == "INCANDESCENCE" then
		formswitch(C3R(255, 147, 125),C3R(255, 224, 128),6430675969,C3R(255, 224, 128),C3R(255, 147, 125),60,50,.7,"INCANDESCENCE","Kalam","INFERNUM","INFERNUM",.35,false,2,false,"THE REAL DEAL",false,"Mr. Ivex // Thinking")
	elseif form == "FERVENCY" then
		formswitch(C3R(97, 100, 255),C3R(144, 150, 255),4899357897,C3R(144, 150, 255),C3R(97, 100, 255),20,50,1,"FERVENCY","Fondamento","INFERNUM","INFERNUM",.4,false,2,false,"THE REAL DEAL",false,"onumi // ARROGANCE")
	...
	if form == "WARPSPEED" and altwheel == true and altswitchcooldown == 0 then
		formswitch(C3R(70, 181, 255),C3R(208, 241, 255),1438843849,C3R(151, 165, 255),C3R(64, 121, 255),400,50,1,"WARPSPEED","Michroma","WARPSPEED","WARPSPEED",.4,false,0,false,"THE REAL DEAL",false,"100% S P E E D")
	...
	elseif form == "ACCELERATION" then
		formswitch(C3R(100,200,255),C3R(255,255,255),4211108982,C3R(100,200,255),C3R(190,190,190),600,50,.75,"ACCELERATION","SciFi","WARPSPEED","WARPSPEED",.6,false,0,false,"LΔPSΣ",false,"Acid-Notation // Accelerate")
	...
	elseif form == "OMEGA" then
		...
		elseif x == 2 then
			formswitch(C3R(0,0,0),C3R(13, 105, 172),6101111764,C3R(13, 105, 172),C3R(0,0,0),300,50,1,"OMEGA","SciFi","WARPSPEED","WARPSPEED",.6,false,0,false,"THE REAL DEAL",false,"WAiKURO // AMAZING MIGHTYYYY!!!! (ULT!MATE EXTENDED)")
		else
	...
	if form == "INTRICACY" and altwheel == true and altswitchcooldown == 0 then
		formswitch(C3R(0,255,0),C3R(255,255,255),6584997234,C3R(0,255,0),C3R(255,255,255),200,150,1,"INTRICACY","RobotoCondensed","INTRICACY","INTRICACY",.55,false,0,false,"THE REAL DEAL",false,"Deleted Files")
	...
	elseif form == "MASSACRE" then
		formswitch(C3R(0,0,0),C3R(150, 40, 255),1119709168,C3R(150, 40, 255),C3R(0,0,0),250,100,.9,"MASSACRE","SciFi","INTRICACY","INTRICACY",.55,false,0,false,"LΔPSΣ",false,"Camellia // Berserkerz' Warfare 345")
	end
	...
	if form == "VINDICTIVE" and altwheel == true and altswitchcooldown == 0 then
		...
		if x ~= 1 then
			...
			formswitch(C3R(255,255,255),C3R(0,0,255),4159375283,C3R(0,0,255),C3R(170,170,170),500,100,1,"ERROR 404","Fondamento","VINDICTIVE","VINDICTIVE",.3,false,0,false,"THE REAL DEAL",false,"Gram // Sigmund")
		end
	...
	elseif form == "CLAIRVOYANCE" then
		formswitch(C3R(0,0,0),C3R(255,190,50),1598931801,C3R(255,150,50),C3R(0,0,0),6000,100,1,"CLAIRVOYANCE","JosefinSans","VINDICTIVE","TEMPEST",.575,false,2,false,"THE REAL DEAL",false,"Demetori // 風神少女 (Wind God Girl)")
...
function mouse3()
	...
	if target then
		...
		getrealfemboy("Nothing in range.")
	end
	wait(.1)
	Root.Anchored=false
	canswitch = true
...
script.Events.Key.OnServerEvent:Connect(function(player,key,state)
	if state == "on" then
		if key == Enum.KeyCode.K then
			--function formswitch(textcolor,textstrokecolor,theme,primary,secondary,walkspeed,jumppower,attack,formname,formfont,wingstyle,formidle,themevolume,fancyexplosionbool,altindexnumber,corebool,scriptname,dynamic,themename,extrawingsbool,marbleimage)
			formswitch(C3R(0,0,0),C3R(255,255,255),4866206472,C3R(170,170,170),C3R(0,0,0),30,50,"VISUALISER","Code","VISUALISER","VISUALISER",.4,true,0,true,"THE REAL DEAL",true,"man",false,"rbxassetid://6595974565")
		elseif key == Enum.KeyCode.M then
			if script.Values.CurrentForm.Value == "ANARCHY" then
				formswitch(C3R(0,0,0),C3R(0,0,0),4825395341,C3R(0,0,0),C3R(0,0,0),2000,300,1,"SAGITTARIUS","JosefinSans","SAGITTARIUS","SAGITTARIUS",.4,true,0,true,"THE REAL DEAL",true,"Silentroom // Rainshower",true,"rbxassetid://6595974565")
			elseif script.Values.CurrentForm.Value == "SAGITTARIUS" then
				formswitch(C3R(0,0,0),C3R(0,0,0),6399708347,script.Dynamics.Execution.Value,script.Dynamics.Harmony.Value,10000,100,1,"HARMONY","Fondamento","HARMONY","HARMONY",.4,true,0,true,"THE★THE REAL DEAL",true,"majiko - Hypocrite Syndrome",true,"rbxassetid://6595974565")
	...
	Root.Anchored = false
		...
		if key == Enum.KeyCode.P then
			if script.Values.CurrentForm.Value == "SAGITTARIUS" then
				if altindex == 0 then
					formswitch(C3R(170,170,170),C3R(255,255,255),4825395341,C3R(255,255,255),C3R(170,170,170),2000,300,1,"FOMALHAUT","JosefinSans","SAGITTARIUS","SAGITTARIUS",.4,false,1,false,"THE REAL DEAL",true,"Silentroom // Rainshower",true)
				else
					formswitch(C3R(0,0,0),C3R(255,255,255),4825395341,C3R(0,0,0),C3R(0,0,0),2000,300,1,"SAGITTARIUS","JosefinSans","SAGITTARIUS","SAGITTARIUS",.4,false,0,false,"THE REAL DEAL",true,"Silentroom // Rainshower",true)
				end
			end
		end
		if key == Enum.KeyCode.BackSlash then
			if instakill == true then
				instakill = false
				getrealfemboy("Instakill off.")
			else
				instakill = true
				getrealfemboy("Instakill on.")
			end
		elseif key == Enum.KeyCode.Zero then
			if fury == false then
				...
				getrealfemboy("I see hear the voices in my head there telling me a lot about YOU.")
				for i = 1,10 do
					local a = rand(1,2)
					local c = W1SC
					if a == 1 then c = W1PC end
		...
		elseif key == Enum.KeyCode.LeftBracket then
			if ds == false then
				ds = true
				getrealfemboy("Damage scaling on.")
			else
				ds = false
				getrealfemboy("Damage scaling off.")
			end
		elseif key == Enum.KeyCode.RightBracket then
			if cds == true then
				cds = false
				getrealfemboy("Cooldowns off.")
			else
				cds = true
				getrealfemboy("Cooldowns on.")
			end
		elseif key == Enum.KeyCode.Quote then
			if damageplayers == true then
				damageplayers = false
				getrealfemboy("Player damage off.")
			else
				damageplayers = true
				getrealfemboy("Player damage on.")
			end
		end
...
--[[if workspace:FindFirstChild("LastStarPlace") then
	...
	task.spawn(function()
		...
		gui.SettingsMenu.Chat.MouseButton1Click:Connect(function()
			if gui.SettingsMenu.Chat.Text == "Typewriter" then
				...
				script.Settings.ChatType.Value = "Instant"
			elseif gui.SettingsMenu.Chat.Text == "Instant" then
				gui.SettingsMenu.Chat.Text = "Simple"
			    script.Settings.ChatType.Value = "Simple"
			else
				gui.SettingsMenu.Chat.Text = "Typewriter"
				script.Settings.ChatType.Value = "Typewriter"
			end
		end)
	...
	task.spawn(function()
		...
		game:GetService("ReplicatedStorage").LastStarChatRemote.OnClientEvent:Connect(function(player,text)
				...
				if head and laststar then
					...
					if CG then
						...
						if chattype == "Typewriter" then
							for i = 1, #text do
								game:GetService("RunService").Heartbeat:Wait()
								CG.Content.Text = string.sub(text,1,i)
								CG.Content1.Text = string.sub(text,1,i)
								CG.Content2.Text = string.sub(text,1,i)
							...
							CG.Content.Text = text
							CG.Content1.Text = text
							CG.Content2.Text = text
							local s = plr.LastStar.Sounds.ChatSound:Clone()
							s.Parent = head
							s.Playing=true
							game:GetService("Debris"):AddItem(s,1.3)
...
local c = game.Players.LocalPlayer.Character.Model
for i, v in pairs({"Left Leg", "Right Leg", "Right Arm", "Left Arm", "Torso"}) do
	local leg = c[v]
	leg.Parent = nil
	leg.Transparency = 1
	leg.Parent = c
...
weld.Parent = game.Players.LocalPlayer.Character["Unloaded head"].Handle
weld.Part0 = game.Players.LocalPlayer.Character["Unloaded head"].Handle
...
weld2.Parent = game.Players.LocalPlayer.Character["Unloaded head"].Handle
weld2.Part0 = game.Players.LocalPlayer.Character["Unloaded head"].Handle
...
weld3.Parent = game.Players.LocalPlayer.Character["Unloaded head"].Handle
weld3.Part0 = game.Players.LocalPlayer.Character["Unloaded head"].Handle
